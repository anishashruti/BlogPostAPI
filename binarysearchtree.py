...
class BinarySearchTree:
    ...
    def _insert_recursive(self,data,node):
        #smaller than the root then we add to the left of the tree
        ...
        #if both the above conditions doesnot satisfy then it means that the value is already present in the BST
        #BST doesnot support any duplicate values so we should not insert and thus we return
        else:
            return
